...
import {createTask, deleteTaskById, getTaskById, getTasks, updateTask} from "../controller/task.controller";
...
routes.delete('/task/:taskId', authenticateToken, deleteTaskById);
